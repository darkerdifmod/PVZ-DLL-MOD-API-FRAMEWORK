...
CONST DWORD REANIMTRYTOGET = 0x453CB0;
__declspec(naked) Reanimation* LawnApp::ReanimationTryToGet(ReanimationID ID)
{
	__asm
	{
		mov eax, ecx          // this -> eax (LawnApp*)
		mov ecx, [esp + 4]    // ReanimationID -> ecx
		call REANIMTRYTOGET   // returns Reanimation* in eax (or null)
		ret 4                 // pop our one stack argument
	}
}
