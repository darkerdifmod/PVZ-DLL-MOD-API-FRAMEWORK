...
CONST DWORD REANIMSHOWPREFIXADDR = 0x5331C0;
__declspec(naked) void Zombie::ReanimShowPrefix(const char* TrackPrefix, int RenderGroup)
{
	__asm
	{
		mov eax, ecx
		jmp REANIMSHOWPREFIXADDR
	}
}
