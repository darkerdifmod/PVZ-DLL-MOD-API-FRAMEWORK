...
public:
	...
	Coin* GetNearestPickup(float MinDist = 0, CoinType = PICKUP_NONE, bool IsBlacklist = false);
	...
	std::list<Coin*> GetPickupsAround(int LaneRange = 1, int ColRange = 1, CoinType = PICKUP_NONE, bool IsBlacklist = false);
